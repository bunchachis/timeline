...
(function() {
  var Registry, TL, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    __slice = [].slice,
  ...
  TL.InteractiveCreationMode = (function() {
    ...
    InteractiveCreationMode.prototype.build = function() {
      ...
      return this.$indicator.append($('<button />').text('отменить').click(function() {
        return _this.deactivate();
      }));
    };
          ...
          TL.Misc.scrollize($dom, 'xy', [
            {
              ...
              getTarget: function() {
                var _ref6, _ref7;
                return (_ref6 = (_ref7 = _this.getView('atSidebar')) != null ? _ref7.$dom : void 0) != null ? _ref6 : null;
              }
            }
          ]);
          break;
  ...
  TL.Element.Range = (function(_super) {
    ...
    Range.prototype.createViews = function() {
      var group, _i, _len, _ref7;
      _ref7 = this.timeline.groups;
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        group = _ref7[_i];
  ...
  TL.Element.Dash = (function(_super) {
    ...
    Dash.prototype.createViews = function() {
      var group, _i, _len, _ref8;
      _ref8 = this.timeline.groups;
  ...
  TL.Element.Item = (function(_super) {
    ...
    Item.prototype.remove = function() {
      var _this = this;
      this.timeline.items = this.timeline.items.filter(function(item) {
        return _this !== item;
      });
  ...
  TL.Element.DashRule = (function() {
    ...
    DashRule.prototype.removeDashes = function() {
      var dash, _i, _len, _ref10, _results;
      _ref10 = this.timeline.dashes;
      _results = [];
    ...
    DashRule.prototype.calculateDashes = function() {
      var dashes, offset, range, step, time, _i, _len, _ref10, _ref11, _ref12;
      dashes = [];
      step = (_ref10 = this.raw.step) != null ? _ref10 : Infinity;
      offset = (_ref11 = this.raw.offset) != null ? _ref11 : 0;
      _ref12 = this.timeline.ranges;
    ...
    DashRule.prototype.isTimeExcluded = function(time) {
      var excluderId, _i, _len, _ref10;
      if (this.raw.exclude != null) {
        _ref10 = this.raw.exclude;
        for (_i = 0, _len = _ref10.length; _i < _len; _i++) {
          excluderId = _ref10[_i];
  ...
  TL.Element.Now = (function(_super) {
    ...
    function Now() {
      _ref10 = Now.__super__.constructor.apply(this, arguments);
      return _ref10;
    }
    ...
    Now.prototype.createViews = function() {
      var group, _i, _len, _ref11;
      _ref11 = this.timeline.groups;
