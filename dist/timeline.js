...
(function() {
  ...
  TL.Sized = (function() {
    ...
    Sized.prototype.calcSize = function(axis) {
      var child, j, len, max, maxRule, ref, results, rule, size;
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        child = ref[j];
        results.push(child.calcSize(axis));
      }
      return results;
    };

    Sized.prototype.calcSizeByRule = function(axis, rule) {
      var child, innerSpace, j, len, parent, parts, percents, ref, ref1, remainingSpace, totalParts;
      if ((rule == null) || rule[0] === 'content') {
        ...
        parts = rule[1];
        parent = rule[2];
        ref1 = parent.getChildrenPartsAndRemaining(axis), totalParts = ref1[0], remainingSpace = ref1[1];
    ...
    Sized.prototype.recalcPartialChildren = function(axis) {
      var child, j, len, ref, results, rule;
      ref = this.getChildrenElements();
      results = [];
      for (j = 0, len = ref.length; j < len; j++) {
        child = ref[j];
    ...
    Sized.prototype.getChildrenPartsAndRemaining = function(axis) {
      var child, children, j, len, remainingSpace, rule, totalParts;
      totalParts = 0;
    ...
    Sized.prototype.getCurrentSizeRule = function(axis) {
      var ref;
      return (ref = this.sizeCache[axis].overridedRule) != null ? ref : this.getSizeRule(axis);
    };
  ...
  TL.Range = (function() {
    ...
    Range.prototype.format = function() {
      return '[' + (this.from === -2e308 ? '-∞' : this.from) + '; ' + (this.to === 2e308 ? '∞' : this.to) + ')';
    };
  ...
  TL.Element.Root = (function(superClass) {
    ...
    Root.prototype.getRawHeight = function() {
      var ref;
      return (ref = this.timeline.config.height) != null ? ref : 'content';
    };
  ...
  TL.Element.Line = (function(superClass) {
    ...
    Line.prototype.calculateSlotsAndLockers = function() {
      ...
      if (this.raw.restrictSlotsTo != null) {
        ...
        for (j = 0, len = ref.length; j < len; j++) {
          rule = ref[j];
          step = (ref1 = rule.step) != null ? ref1 : 2e308;
    ...
    Line.prototype.calculateToTime = function(from, duration) {
      var fromSlot, j, len, ref, remainingDuration, slot, startPoint, timeInSlot;
  ...
  TL.Element.Item = (function(superClass) {
    ...
    Item.prototype.getDurationInSlots = function() {
      var betweenSlots, duration, fromSlot, j, len, slot, toSlot;
      ...
      if (fromSlot === toSlot) {
        ...
        betweenSlots = (function() {
          ...
          ref = this.getLine().getSlots();
          results = [];
          for (j = 0, len = ref.length; j < len; j++) {
            slot = ref[j];
            if ((fromSlot.raw.from < (ref1 = slot.raw.from) && ref1 < toSlot.raw.from)) {
              results.push(slot);
            }
          }
          return results;
        ...
        for (j = 0, len = betweenSlots.length; j < len; j++) {
          slot = betweenSlots[j];
    ...
    Item.placeDefault = function(view) {
      var line, offset, toRange;
      line = this.getLine();
      offset = this.timeline.getOffset(this.raw.from);
      if (offset == null) {
        toRange = this.timeline.getRangeByTime(this.raw.to - 1);
        offset = this.timeline.getOffset(toRange.raw.from);
      }
      return view.$dom.css({
        top: line.getVerticalOffset() + line.getInternalVerticalOffset(),
        height: line.getInnerHeight(),
  ...
  TL.Element.DashRule = (function() {
    ...
    DashRule.prototype.calculateDashes = function() {
      ...
      dashes = [];
      step = (ref = this.raw.step) != null ? ref : 2e308;
